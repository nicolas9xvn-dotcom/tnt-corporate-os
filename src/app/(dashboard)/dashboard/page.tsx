...
export default async function DashboardPage() {
  ...
  const [orgRes, buRes, deptRes, agentRes] = await Promise.all([
    ...
    supabase
      .from("agents")
      .select(
        "id, business_unit_id, department_id, name, role, level, status, approval_level, responsibilities, tools, kpi, escalation_note, reports_to, system_prompt, house_rules, last_task_completed_at, created_at"
      )
      .order("created_at", { ascending: true }),
  ]);
